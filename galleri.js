...
function loadFilter() {
	...
	if (sort !== null && desktop == false) {
		...
		document.querySelector("#itemSection").style.visibility = "hidden";
	}
	if (desktop == true) {
		//		console.log(document.querySelector("#filterContainer"));
		let fil = document.querySelector("#filterContainer");
	}
	if (sort !== null) {
//		console.log(sort);
//		console.log("tralalal", document.querySelector("#" + sort));
